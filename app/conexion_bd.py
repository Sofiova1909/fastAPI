...
def crear_tablas(app: FastAPI):
    ...
    yield #no hay nada que retornar o ejecutar


#definir el metodo para la sesion
def obtener_sesion():
    with Session(motor_bd) as mi_sesion:
        yield mi_sesion #retornar la sesion 

#Denominado inyeccion de dependencias
#registra la sesion como dependencia, utilizada de los enpoints
